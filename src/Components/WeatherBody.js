    ...
    return (
        <> {
            ...
            city && localKey > 0 && <div className={
                ...
                <CityDetails city={city} //CityDetails component is the upper part of the app where details of the city are shown
                    localKey={localKey}
                    onChange={setValue}
                    metric={metric}
                    unitChange={unitChange}/>
                <DailyReport localKey={localKey} //DailyReport component is the lower part of the app where daily forecasts are shown for the current day and next 4 days
